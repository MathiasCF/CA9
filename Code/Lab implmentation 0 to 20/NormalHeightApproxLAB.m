...
for episode = 1:1
    ...
    for ii = 1:maxstep
        ...
        newstate = nextstatefunctionapproxLAB(state, Q, epsilon,h,demand,timediscretisation,ii,exponent);    %gives new height and next time, and action
        action = newstate(3);
...
hold off
%exportgraphics(figure(3), fullfile('..\Report\figures','AlphaSweepApprox.pdf'))
