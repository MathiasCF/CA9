...
sigma = 3.5;% + 0.5*ep;                                            %width of features
...
for episode = 1:1
    ...
    for ii = 1:maxstep
        ...
        newstate = nextstatecontinioustime(state, Q, epsilon,h,demand,timediscretisation,ii,exponent);    %gives new height and next time, and action
        action = newstate(3);
